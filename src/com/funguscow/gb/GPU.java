    ...
    private void scanline(){
        ...
        if(bg_on){
            ...
            if(window_on && window_x >= 0 && window_y >= 0 && window_x <= 166 && window_y <= 143){
                tilemap_base = window_map_high ? 0x1c00 : 0x1800;
    ...
    public void write(int address, int value){
        switch(address >> 8){
            ...
            case 0xfe: // OAM
                ...
                switch(address & 3){
                    case 0: //Y
                        sprite.y = value; break;
                    case 1: // X
                        sprite.x = value; break;
                    case 2:
                        sprite.pattern = value; break;
                    case 3:{
            ...
            case 0xff: // Registers
                switch(address & 0xf){
                    ...
                    case 0x2: // STAT
                        ...
                        break;
                    case 0x3:
                        scroll_y = value; break;
                    case 0x4:
                        scroll_x = value; break;
                    case 0x5:
                        lyc = value; break;
                    case 0x7:
                        bg_pal[0] = value & 3;
                    ...
                    case 0x9:
                        ...
                        break;
                    case 0xa:
                        window_y = value; break;
                    case 0xb:
                        window_x = value; break;
                }
        }
    }
